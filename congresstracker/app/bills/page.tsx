...
export default async function BillListPage({ searchParams }: PageProps) {
  const filters = {
    congress: searchParams.congress,
    status: searchParams.status,
    q: searchParams.q,
    page: searchParams.page,
  };

  const { bills, total, page } = await getBills(filters);
...
function buildUrl(
  page: number,
  filters: { congress?: string; status?: string; q?: string },
): string {
