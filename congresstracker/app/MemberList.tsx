...
export function MemberList() {
  ...
  const { data, loading } = useAsync(
    () => getMembers(filters),
    [sp.toString()],
    { members: [], total: 0, page: 0 },
  );
  const { members, total, page } = data;
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6 py-8">
      ...
      {/* Filter form — submits by updating the URL query string */}
      <form
        onSubmit={onSubmit}
...
function buildFilterUrl(page: number, filters: Filters): string {
