...
export const data = {
  ...
  projects: [
    ...
    },
    {
      ...
      tag: "Web Game",
      glyph: "code",
      desc: "A minimalist real-time strategy .io game built from scratch on Canvas — lasso your dots, draw their paths, encircle the enemy's cities and starve their army. Deterministic seeded simulation, a two-layer AI opponent, territory flood-fill with encirclement, and a city economy with supply caps and starvation — all in a ~14 KB bundle with no game engine.",
      stack: ["TypeScript", "Vite", "Canvas 2D", "Vitest"],
      github: "https://github.com/husseingpp/hussainkanaan/tree/main/dotfront",
      demo: "https://husseingpp.github.io/hussainkanaan/dotfront/",
    },
    {
      title: "Lebanese Café Footfall Tracker",
      tag: "Data Pipeline",
      glyph: "database",
      desc: "An end-to-end data pipeline that ingests Beirut café data from the Google Places API into PostgreSQL, analyses it with window-function SQL (CTEs, RANK(), partitioned averages), scores multilingual English + Arabic review sentiment, and ships a self-contained interactive Plotly report with no runtime backend.",
      stack: ["Python", "PostgreSQL", "SQL", "Plotly", "VADER"],
      github: "https://github.com/husseingpp/hussainkanaan/tree/main/cafe-footfall-tracker",
      demo: "https://husseingpp.github.io/hussainkanaan/cafe-footfall-tracker/",
    },
    {
