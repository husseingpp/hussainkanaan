...
2. **Globe texture.** The globe uses the standard three-globe example textures
   (`earth-night.jpg` + `earth-topology.png`) loaded from a CDN at runtime, for a real Earth
   surface rather than a blank sphere.
